...
#define  KeySleepTime "aoff"
#define  KeyScreenSaverTime "saver"
...
#define KeySkin "skin"
#define KeyEmbeddedSkins "eskins"
...
String BPLSettings::jsonSystemConfiguration(void){
    ...
    root[KeyScreenSaverTime] =   syscfg->screenSaverTime;
	root[KeySleepTime] = syscfg->sleepTimeout;
