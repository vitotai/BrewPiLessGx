...
#if !defined(ESP32_2432S024N) && !defined(ESP32_2432S024R) && !defined(ESP32_2432S024C) && !defined(ESP32_2432S032C) && !defined(ESP32_2432S028R) && !defined(ESP32_3248S035R) && !defined(ESP32_3248S035C) && !defined(ESP32_8048S070N) && !defined(ESP32_8048S070C)
#error Please define type: ESP32_2432S024N, ESP32_2432S024R, ESP32_2432S024C,  ESP32_2432S032C, ESP32_2432S028R, ESP32_3248S035R, ESP32_3248S035C, ESP32_8048S070N or ESP32_8048S070C
#endif
...
// Setup interfaces
  ...
  static lv_color_t *buf=(lv_color_t*)malloc(sizeof(lv_color_t) *DRAW_BUFFER_SIZE);
